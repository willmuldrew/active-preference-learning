...
--train.batch_size 8 --train.grad_acc_steps 8 --train.lr 5e-06 \
...
$PYTHON direct/main.py --seed $SEED --eval.defer true --wandb_tags lora-sweep1 --train.dpo.beta $BETA $SHARED_ARGS $ADDITIONAL_ARGS 
