...
M_SCHEDULE="[0,128,128,128,128,128,128]"
...
$PYTHON direct/main.py --seed $SEED --eval.defer true --wandb_tags xmas-noreset1 --train.dpo.beta $BETA $SHARED_ARGS $ADDITIONAL_ARGS
